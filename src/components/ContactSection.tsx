  ...
  return (
    <section id="contact" className="py-24 sm:py-40 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-5xl relative text-center">
        <Reveal>
          <p className="text-xs uppercase tracking-[0.25em] opacity-55 mb-6">
        ...
        <Reveal delay={0.4}>
          <div className="mt-16 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm opacity-65">
